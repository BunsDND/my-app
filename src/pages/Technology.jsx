...
function getRandomFact() {
  const randomIndex = Math.floor(Math.random() * randomFacts_technology.length);
  return randomFacts_technology[randomIndex];
}
...
export default function Technology() {
  ...
  return (
    <div className="container">
      <h1 className="title">Random Facts about Technology!</h1>
      <p className="content">
      ...
      <ul className="fact-list">
        {randomFacts_technology.map((fact, index) => (
